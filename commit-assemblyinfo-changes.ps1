...
if ($env:APPVEYOR_REPO_TAG -eq "true")
{
    ...
    $nativeFile = "win_dev_adc_native.cpp"
    ...
    # new branch name
    $newBranch = "$env:APPVEYOR_REPO_BRANCH-nfbot/update-version/Windows.Devices.Adc/$env:MyNuGetVersion"
    ...
    {
        $commitMessage = "Update Windows.Devices.Adc version to $env:MyNuGetVersion"
