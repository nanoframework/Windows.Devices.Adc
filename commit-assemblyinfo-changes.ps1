...
else
{
    ...
    git add "source\Windows.Devices.Adc\Properties\AssemblyInfo.cs"
    ...
    # new branch name
    $newBranch = "$env:APPVEYOR_REPO_BRANCH-nfbot/update-version/Windows.Devices.Adc/$env:GitVersion_NuGetVersionV2"
    ...
    {
        $commitMessage = "Update Windows.Devices.Adc version to $env:GitVersion_AssemblySemFileVer"
